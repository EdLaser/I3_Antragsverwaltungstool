...
=== *Services:*
* Antrag anlegen: Die Nutzereingaben werden an das python-Skript übergeben. Mit den Nutzereingaben wird ein Insert-Befehl in der Datenbank ausgeführt um eine neue Zeile anzulegen.
