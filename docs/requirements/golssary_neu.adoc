...
Hochschule für Technik und Wirtschaft Dresden|Bildungsinstitution mit Fokus auf technische und wirtschaftliche Studiengänge [red]#???kann das weg# |

|Plenum |Vollversammlung einer Körperschaft, besonders der Mitglieder eines Parlaments [red]#-> in diesem Fall des Sturas#. |Vollversammlung

|Präsidium|Leitendes Gremium einer Versammlung.|[red]#???#

|Referat [red]#kann weg?#|Abteilung einer Behörde als Fachgebiet eines Referenten.|Abteilung, Sektion 

|Referatskollegium [red]#kann weg?#|Das Referatskollegium ist die Gesamtheit aller Referate.|(keine)

|Referatsleitung [red]#kann weg?#|Ein von der Referatsleitung zur Vertretung des Referates im Referatskollegium bestimmtes Mitglied.|(keine)

|Ressourcen|Bestand an vorhandenen Geldmitteln. |Bestand, Depot  
[red]#kann weg?#

| Studentenrat |Eine Form der Studierendenvertretung an Hochschulen. 
[red]#Vertretung der Studenten an der# #Htw-Dresden#|Studierendenrat
...
| Vorstand der Geschäftsführung [red]#was soll das sein???#|Sprecherinnen und Sprecher sowie Beauftragte die dem Referatskollegium mit beratender Stimme angehören.|Sprecher/innen
|x |x |x 
|===
...
|Anmeldedaten|Zusammensetzung von Benutzername und Passwort.|[red]#???#|Benutzername muss existieren, Passwort muss zu Benutzernamen passen. [blue]#Ein Benutzername darf maximal 1-mal vorhanden sein.#|Login

|Antrag | Textdokument welches bearbeitet wird -> über welches während der Sturasitzung abgestimm/diskutiert wird. Zudem sollte angegeben werden um was für eine Art Antrag es sich handelt #(Änderung,Wahl,Ressource)#| 
Titel,Art des Antrags, Datum, [red]#'.txt?# | txt<2000 Zeichen? , Art des Antrags ausgewählt ausgewählt, Titel<200Zeichen? |  - 
