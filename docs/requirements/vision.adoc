...
=== Referenzen
Externe Quellen Open UP, Ascidoc etc.
...
[blue]#Bestandteil des Studiums SE2#
...
|Die Auswirkung davon ist |	die suboptimale Leistung des Sturas und das langsame Bearbeiten von Anträgen [blue]#fehleranfällig, Prozess uneffizient, Zeitaufwendig, uneinheitlich#
...
|===
[blue]#2 Sichten Antragssteller, Präsidium# 
...
Admin | IT-Mitarbeiter der Hochschule [blue]#Stura oder Laborbereich# | überwacht und wartet die Server der HTW Dresden. Stellt Serverleistung für die Software bereit | 
...
[blue]#Jürgen Anke hinzufügen#
|===

=== Benutzerumgebung

1. Antragssteller
* Anzahl der Nutzer variiert [blue]#Größenordnung#
...
* die [red]#Anwendung kann mit jedem Browser# durchgeführt werden

* [blue]#Welche Geräte benutzen Studis#
2. Antragsverwalter
* [blue]#wie viele + Login + welche Browser+ nicht mobile#
...
[blue]#3. Admin --> Authentifizierung , einer, Browser etc.# 
...
|Vorlagen der Anträge digitalisieren|sehr hoch|Auswahlverfahren, automatische Gererierung der Kennziffer des Antrags |SS2021|
...
[blue]#Tabelle mit Bedarf, Priorität, Feature, Zweck?#
