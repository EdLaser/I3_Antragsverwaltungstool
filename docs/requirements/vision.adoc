...
|der|	Anträge für Wahlen, Ressourcen sowie Beschlüsse stellt
...
[cols="1,3"]
|===
|Für|	das Präsidium (#entscheidendes Gremium?#)
|der|	Anträge für Wahlen und Beschlüsse verwaltet
|Die Lösung ist eine | browserbasierte Anwendung
|welche	| die Bearbeitung und Vertagung der Anträge ermöglicht
|Im Gegensatz zur	|manuelle Verwaltung der Anträge
|Unser Produkt|	erstellt Automatisch die Anträge welche mit der #konfigurierbaren?# Tagesordnung verknüpft werden. Zudem können die Äntrage selbst bearbeitet sowie verschoben werden.
|===
...
| Jürgen Anke | verantwortlicher Professor für die Module SE I/II | Gibt den zeitlichen Rahmen vor und "#überwacht?#" den Fortschritt sowie Prozess unseres Projekts
...
* die Anwendung soll in den Browsern Google Chrome sowie #Firefox# laufen (jeweils neuste Version)

2. Antragsverwalter
* Anzahl der Nutzer variiert zwischen 1 und #5?#
...
3. #Stura/ Netzwerk Admin#
* 1 #oder 2#
* Admin des Sturas / Laborbereichs
* Sollte möglichst leicht unsere Anwendung bearbeiten, updaten oder neustarten könnnen
#* Browserbasietes bearbeitungstool + unsere Dokumentation bzw. kritische Entwicklungsdaten?#
...
Priorisierung von Anträge | hoch  | SS2021 | Übersichtlichkeit bzw. automatische Anordnung der Anträge (erst alle Wahlanträge dann alle Ressourcen etc.)|
#Benachrichtigung von neue Mitgliedern?# | niedrig/extra | SS2021|  | 
Kein Java | hoch | - | #nochmalfragen# |
...
#Information per E-Mail an Wahlkandidaten (welche Infos)# | niedrig | SS02021 | |
Hilfe-Funktion direkt auf Website | niedrig | SS20201 | Anwendung benutzerfreundlich gestallten --> Zugänglichkeit erhöhen |
#E-Mail über Beschlüsse# | niedrig |SS2021 | Stura-Mitglieder kritische Informationen teilweise automatisch mit E-Mails mitteilen |
|===
