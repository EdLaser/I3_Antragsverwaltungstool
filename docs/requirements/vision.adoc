...
|eine erfolgreiche Lösung wäre |	eine Anwendung um korrekt ausgefüllte und nummerierte Formulare zu erstellen und gemäß Priorisierung in der Tagesordung der folgenden Sitzung einzuordnen.
|===
