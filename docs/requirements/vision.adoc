...
Admin | IT-Mitarbeiter der Hochschule | überwacht und wartet die Server der HTW Dresden. Stellt Serverleistung für die Software bereit | 
...
Schriftführer | ist befugt Anträge zu bearbeiten und ihren Status zu ändern | 
|===
