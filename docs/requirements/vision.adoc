...
//* Robustheit eher wichtig bei erstellen neuer Anträge (stand 31.12.2020)
//* Ausfalltoleranz nicht abschätzbar (stand 31.12.2020)
//* Benutzerfreundlichkeit hoch anzusetzen da eher unerfahrene Nutzer (stand 31.12.2020)
//* Mobile Variante geringe Priorität (stand 31.12.2020)
//* Eingabeüberprüfung sinnvoll (stand 31.12.2020)
//* Information per E-Mail an Wahlkandidaten (gut aber kein Muss)
//* Benutzerhandbuch on the fly wenn möglich 
