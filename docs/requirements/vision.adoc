...
[blue]#Priorisierung von Anträge# | hoch  | SS2021 | Übersichtlichkeit bzw. automatische Anordnung der Anträge (erst alle Wahlanträge dann alle Ressourcen etc.)|
...
Automatische Generierung der Tagesordnung| mittel | SS2021 | Verknüpfung mit der Anwendung, Wahlen werden priorisiert|
|===
