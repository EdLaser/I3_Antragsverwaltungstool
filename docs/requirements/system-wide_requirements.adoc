...
* Vorerst wird nur eine deutsche Variante mit deutscher Formatierung enwtickelt
...
* Performance muss nicht zu hoch asufallen da die Anzahl der Anträge gering ist -> Fokus auf interne Bearbeitung 
