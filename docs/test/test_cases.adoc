...
|===
Beschreibung: Prüfen, ob sich ein unvollständiger Antrag einreichen lässt. Dies darf nicht möglich sein.
...
Vorbedingungen: Der Login muss gelungen sein.
...
*TC09 - Felder "Vorschlag" und "Anlage" sollten optimal sein*
|===
