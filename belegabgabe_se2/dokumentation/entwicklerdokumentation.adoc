...
"toggleID1" ist die id des zu Stylenden divs und "radioID" ist die id des Buttons ,hier eine Checkbox, die die Bedungung für den Style wechsel ist. Wenn ".checked" erfüllt ist soll "toggleID1" ausgeblendet werden. Wenn ".checked" nicht erfüllt ist soll "toggleID1" eingeblendet werden. Das ist auch der default fall.
