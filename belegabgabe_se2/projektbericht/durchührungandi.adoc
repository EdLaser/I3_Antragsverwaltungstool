...
|Architektur festgelegt | 03.05 bzw. 17.05 | Auf Systemstruktur einigen, Programmiersprache wählen | Teilweise -> geplante Architektur funktionierte nur Teilweise und musste zum Teil neu konstruiert werden
